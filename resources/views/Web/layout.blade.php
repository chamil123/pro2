...
<!-- Mirrored from demo.hasthemes.com/melani-prev/melani/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 05:21:01 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Site title -->
    <title>Phyramid</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('bower_components/web/assets/img/favicon.ico')}}" type="image/x-icon" />
    <!-- Bootstrap CSS -->
    <link href="{{ asset('bower_components/web/assets/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font-Awesome CSS -->
    <link href="{{ asset('bower_components/web/assets/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- IonIcon CSS -->
    <link href="{{ asset('bower_components/web/assets/css/ionicons.min.css')}}" rel="stylesheet">
    <!-- helper class css -->
    <link href="{{ asset('bower_components/web/assets/css/helper.min.css')}}" rel="stylesheet">
    <!-- Plugins CSS -->
    <link href="{{ asset('bower_components/web/assets/css/plugins.css')}}" rel="stylesheet">
    <!-- Main Style CSS -->
    <link href="{{ asset('bower_components/web/assets/css/style-downy.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 col-6">
                        <div class="logo">
                            <!-- <a href=""> -->
                                <h2>Logo Here</h2>
                                <!-- <img src="{{ asset('bower_components/web/assets/img/logo/logo_4.png')}}" alt="Brand logo"> -->
                            <!-- </a> -->
                        </div>
                    </div>
                                    ...
                                    <ul>
                                        ...
                                        <!-- <li class="static"><a href="#">pages <i class="fa fa-angle-down"></i></a>
                                            <ul class="megamenu dropdown">
                                                ...
                                                <li class="megamenu-banners d-none d-lg-block"><a href="#"><img src="{{ asset('bower_components/web/assets/img/banner/banner-6.jpg')}}" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
  ...
  <!-- <footer>
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="product-large-slider mb-20 slider-arrow-style slider-arrow-style__style-2">
                                    <div class="pro-large-img">
                                        <img src="{{ asset('bower_components/web/assets/img/product/product-details-img1.jpg')}}" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('bower_components/web/assets/img/product/product-details-img2.jpg')}}" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('bower_components/web/assets/img/product/product-details-img3.jpg')}}" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('bower_components/web/assets/img/product/product-details-img4.jpg')}}" alt=""/>
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('bower_components/web/assets/img/product/product-details-img4.jpg')}}" alt=""/>
                                    </div>
                                ...
                                <div class="pro-nav slick-padding2 slider-arrow-style slider-arrow-style__style-2">
                                    <div class="pro-nav-thumb"><img src="{{ asset('bower_components/web/assets/img/product/product-details-img1.jpg')}}" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="{{ asset('bower_components/web/assets/img/product/product-details-img2.jpg')}}" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="{{ asset('bower_components/web/assets/img/product/product-details-img3.jpg')}}" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="{{ asset('bower_components/web/assets/img/product/product-details-img4.jpg')}}" alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="{{ asset('bower_components/web/assets/img/product/product-details-img5.jpg')}}" alt="" /></div>
                                </div>
                            </div>
    ...
    <script src="{{ asset('bower_components/web/assets/js/vendor/modernizr-3.6.0.min.js')}}"></script>
    <!-- Jquery Min Js -->
    <script src="{{ asset('bower_components/web/assets/js/vendor/jquery-3.3.1.min.js')}}"></script>
    <!-- Popper Min Js -->
    <script src="{{ asset('bower_components/web/assets/js/vendor/popper.min.js')}}"></script>
    <!-- Bootstrap Min Js -->
    <script src="{{ asset('bower_components/web/assets/js/vendor/bootstrap.min.js')}}"></script>
    <!-- Plugins Js-->
    <script src="{{ asset('bower_components/web/assets/js/plugins.js')}}"></script>
    <!-- Ajax Mail Js -->
...
<!-- Mirrored from demo.hasthemes.com/melani-prev/melani/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 05:21:50 GMT -->
</html>